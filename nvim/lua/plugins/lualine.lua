...
----insert right
	...
	ins_right { 
	  function()
	    return '󱇘'
	  end,color = { fg = '#FDA900', gui = 'bold' },padding = {left = 0.01, right = 1}}
	ins_right {memory, color = { fg = '#FDA900', gui = 'bold' },padding = {left = 0.5, right = 1}}
	ins_right { 
	  function()
	    return ''
	  end,color = { fg = '#FDA900', gui = 'bold' },padding = {left = 0.1, right = 0.1}}
	ins_right {cpu, color = { fg = '#FDA900', gui = 'bold' },padding = {left = 0.5, right = 1}}
	ins_right { 
	  function()
	    return '󰒆'
	  end,color = { fg = '#FDA900', gui = 'bold' },padding = {left = 0.1, right = 0.1}}
	ins_right {gpu, color = { fg = '#FDA900', gui = 'bold' }, padding = {left = 0.5, right = 0}}
